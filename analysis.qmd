...
# Write: map link the function and each vector/ handy for subgroup analysis- use for multiple imputation and quantitative bias analysis
...
fit_model_by_group <- function(data, group_var) {
  data |>
    ...
    #reframe is another way to do iteration
